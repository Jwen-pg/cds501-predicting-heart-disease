...
```{r}
png(file="../box_age.png", width=600, height=350)
ggplot(data = data, aes(x=Target,y=Weight)) + geom_jitter(color="black", size=0.1, alpha=0.2) + geom_boxplot(outlier.size=4, outlier.colour='blue', alpha=0.1)
dev.off()
```
