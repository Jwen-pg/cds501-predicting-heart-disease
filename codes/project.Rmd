...
```{r}
png(file="../figures/box_weight_eda.png", width=600, height=350)
...
```{r}
png(file="../figures/box_height_eda.png", width=600, height=350)
...
```{r}
png(file="../figures/box_systole_eda.png", width=600, height=350)
...
```{r}
png(file="../figures/box_diastole_eda.png", width=600, height=350)
...
```{r}
png(file="../figures/box_bmi_eda.png", width=600, height=350)
...
# saves plot
png(file="../figures/class_dist_eda.png", width=600, height=350)
ggplot(data) + geom_bar(aes(x = Target, fill = Target), alpha=0.8) + theme_bw() + ggtitle("Class Distribution") + xlab("Target") + ylab("Count") + scale_fill_manual(values=c("#15158a", "#eb4034"))
dev.off()
```
